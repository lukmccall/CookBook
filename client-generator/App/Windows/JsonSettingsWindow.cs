...
namespace client_generator.App.Windows
{
    public class JsonSettingsWindow : Window
    {
            ...
            "Code Generator - Deserialization settings")
        {
            ...
            _nullValueHandlingOptions = new RadioGroup(new[] {"Include", "Ignore"}, (int) _jsonSerializerSettings.NullValueHandling);
            ...
            _constructorHandlingOptions = new RadioGroup(new[] {"	Default", "	AllowNonPublicDefaultConstructor"}, (int) _jsonSerializerSettings.ConstructorHandling);
            ...
            _missingMemberHandlingOptions = new RadioGroup(new[] {"Ignore", "Error"}, (int) _jsonSerializerSettings.MissingMemberHandling);
        ...
        private void ProcessInput()
        {
            ...
            _jsonSerializerSettings.MissingMemberHandling = (MissingMemberHandling) _missingMemberHandlingOptions.Selected;
