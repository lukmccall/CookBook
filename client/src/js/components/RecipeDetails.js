				...
				<div className="recipe-details">
					<div className="recipe-details-row">
						...
						<div className="recipe-details-right-side side">
							<Accordion>
								<div className="accor">
									<div className="accor-title" onClick={this.onClickIngridients}> Ingredients</div>
									<div className="accor-details" id="ingridients">
									</div>
								</div>
								<div className="accor">
									<div className="accor-title" onClick={this.onClickEquipment}> Equipment</div>
									<div className="accor-details" id="equipment">
									</div>
								</div>
								<div className="accor">
									<div className="accor-title" onClick={this.onClickSteps}> Steps</div>
